...
fn main() {
    let result = {
        // NOTE calling the functions from the modules by their full path
    ...
    {
        // NOTE importing only necessary functions from the module
        ...
        // NOTE once the scope ends, everything is dropped
    }
}
